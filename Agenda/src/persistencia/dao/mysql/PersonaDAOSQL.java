...
{
	private static final String insert = "INSERT INTO personas(idPersona, nombre, telefono, calle, altura, piso, depto, localidad, email, fechaCumpleaÒos, tipoDeContacto)" + "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public boolean insert(PersonaDTO persona)
	{
		...
		try 
		{
			...
			statement.setString(10, persona.getFechaCumpleaÒos());
